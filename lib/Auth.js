...
module.exports = function( app ) {
  ...
  class Auth {
    ...
    // headers is optional.  If passed, will be used strait.  If not,
    // then they will be generated based on the state of this object.
	...
	url: DMS + '/validate',
	method: 'GET',
	headers: this.makeAuthHeaders( session )
